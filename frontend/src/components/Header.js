...
export default function Header({ cartCount, openCart, user, adminToken, onUserLogout, onAdminLogout, wishlist = [], toggleWishlist, addToCart, isWishlistOpen, setIsWishlistOpen }) {
