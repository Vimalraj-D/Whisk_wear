      ...
      {categories.length === 0 ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '4rem' }}>
          {categories.map((cat, idx) => {
            ...
            return (
              <ScrollReveal key={cat.id} direction="up" threshold={0.05}>
                <div style={{ display: 'flex', flexDirection: idx % 2 === 0 ? 'row' : 'row-reverse', gap: '3rem', alignItems: 'center', flexWrap: 'wrap' }}>
