...
export default function AdminLayout({ adminToken, showToast, onSessionExpired }) {
  ...
  const sidebarMenu = [
    ...
    { name: 'Newsletter', icon: <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg> }
  ];
      ...
      <main className="admin-main-content">
        ...
        <div className="admin-content-inner">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
            <div>
              ...
              <p style={{ color: 'var(--text-secondary)' }}>
                ...
                {tab === 'Newsletter' && 'Compose and send formal newsletter campaigns to subscribers.'}
              </p>
            </div>
          ...
          {tab === 'Products' && (
            ...
            {tab === 'Newsletter' && <NewsletterPage adminToken={adminToken} showToast={showToast} />}
        </div>
